...
bvnmsg_nbrerepet = 1 # Nombre de répétitions du message qui affiche les infos du jour
bvnmsg_minuteur = 13	 # Nombre de minutes avant l'exécution du message
...
while True:
	...
	bvnmsg = "Eh !, nous sommes le " + day + " " + month + " " + year + ", Bonne journee !"
	if bvnmsg_activation:
		if bvnmsg_minuteur == yt_minuteur:
			show_message(device, "bvnmsg_minactu ne dois pas etre = a yt_minactu.", fill="white", font=proportional(CP437_FONT))
		else:
			if sec == "15":
